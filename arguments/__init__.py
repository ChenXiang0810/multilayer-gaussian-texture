...
class PipelineParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.compute_SHs_python_defer = False
        self.compute_cov3D_python = False
        self.tracing = False
        self.sample_num = 64
        self.debug = False
        self.save_training_vis = False
        self.save_training_vis_iteration = 1000  # 1000
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.light_lr_init = 0.001  # 0.01
        self.light_lr_final = 0.0001  # 0.001
        self.light_lr_delay_steps = 0
        self.light_lr_delay_mult = 0.0
        self.light_lr_dc = 0.005
        self.light_lr_rest = 0.0005
        ...
        self.lambda_albedo_smooth = 0.0
        self.lambda_specular_smooth = 0.0
        self.lambda_albedo_smooth_tex = 0.0
        self.lambda_specular_smooth_tex = 0.0
        self.lambda_normal_smooth_tex = 0.0
        self.lambda_latent_smooth = 0.0
