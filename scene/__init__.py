...
class Scene:
    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, shuffle=True,
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["NerfTexture"](args.source_path, args.images, args.eval,
                                                          debug=args.debug_cuda)
    ...
    def save(self, iteration):
        ...
        self.gaussians.save_light(os.path.join(point_cloud_path, "light.npy"))
        self.gaussians.save_decoder_params(os.path.join(point_cloud_path, "decoder_params.pth"))
        self.gaussians.save_encoder_params(os.path.join(point_cloud_path, "encoder_params.pth"))
